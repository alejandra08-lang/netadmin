...
const crear_equipo = async (req, res) => {
    const { eqp_version, eqp_nombre_host, eqp_tipo_equipo, eqp_en_linea, eqp_fecha_registro, eqp_modelo, eqp_marca, eqp_estructura, id_campana} = req.body;
    if (!eqp_version || !eqp_nombre_host || !eqp_tipo_equipo ||!eqp_en_linea ||!eqp_fecha_registro ||!eqp_modelo ||!eqp_marca ||!eqp_estructura ||!id_campana) {
